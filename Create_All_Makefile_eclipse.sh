...
bash Create_Coeos_Makefile_eclipse.sh -enable-cairo $*
bash Create_Leto_Makefile_eclipse.sh -enable-cairo $*
bash Create_Sleto_Makefile_eclipse.sh -enable-cairo $*
bash Create_CCLeto_Makefile_eclipse.sh $*
