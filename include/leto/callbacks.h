...
extern void entry_group_callback_nom(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_taillex(GtkWidget * widget, GtkWidget * entry,t_gennet_script *script_gui);
extern void entry_group_callback_tailley(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_seuil(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_learning_rate(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_simulation_speed(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_type2(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_ech_temps(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_tolerance(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_alpha(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_nbre_de_1(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_dvp(GtkWidget * widget, GtkWidget * entry,t_gennet_script *script_gui);
extern void entry_group_callback_dvn(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_sigma_f(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void combo_debug_groupe_callback(GtkWidget * widget, GtkWidget * entry, t_gennet_script *script_gui);
extern void entry_group_callback_noise_level(GtkWidget * widget,  GtkWidget * entry, t_gennet_script *script_gui);

extern void combo_reverse_groupe_callback(GtkWidget * widget, GtkWidget * entry,  t_gennet_script *script_gui);
extern void entry_group_callback_plan(GtkWidget * widget, GtkWidget * entry,  t_gennet_script *script_gui);
