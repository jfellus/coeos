...
extern void entry_group_callback_comment(GtkWidget * widget, GtkWidget * entry, TxDonneesFenetre *onglet_leto);
extern void entry_link_callback_comment(GtkWidget * widget, GtkWidget * entry, TxDonneesFenetre *onglet_leto);
